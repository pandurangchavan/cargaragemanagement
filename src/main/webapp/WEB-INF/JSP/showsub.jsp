            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    <thead class="table-dark">
                        <tr>
                            <th scope="col">Sub Service ID</th>
                             <th scope="col">Service ID</th>
                            <th scope="col">SubService Name</th>
                            <th scope="col">SubService Description</th>
                            <th scope="col">SubService Price</th>
                        </tr>
                    </thead>
                    <tbody>
                        <c:forEach items="${subservice}" var="service">
                            <tr>
                                <td>${service.subServiceID}</td>
                                <td>${service.serviceID}</td>
                                <td>${service.subServiceName}</td>
                                <td>${service.subServiceDescription}</td>
                                <td>${service.subServicePrice}</td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
